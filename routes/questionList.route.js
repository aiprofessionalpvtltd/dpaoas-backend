...
// Edit
router.put('/editQuestionList', questionList.editQuestionList);
...
// Update Question List By Adding Questions
/**
 * @swagger
 * /api/questionList/updateQuestionList/{id}:
 *   put:
 *     summary: Update Question List
 *     tags: [Question Lists]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *         description: A successful response
 */
router.put('/updateQuestionList/:id', questionList.updateQuestionList)
...
/**
 * @swagger
 * /api/questionList/updateSupplementaryList/{id}:
 *   put:
 *     summary: Update Supplementary List
 *     tags: [Question Lists]
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 *         description: Supplementary List Id
 *         schema:
 *           type: integer
 *     requestBody:
 *       required: true
 ...
 *         description: A successful response
 */
router.put('/updateSupplementaryList/:id', questionList.updateSupplementaryList)
