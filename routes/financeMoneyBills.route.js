...
const introducedInSenateBills = require("../controllers/financeMoneyBills.controller");
...
router.put('/sendForTranslation/:id', introducedInSenateBills.sendForTranslation);
