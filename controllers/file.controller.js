...
const fileController = {
    ...
    findFilesByRegisterId: async (req, res) => {
        try {
            logger.info(`fileController: findFilesByRegisterId with parameters ${JSON.stringify(req.params)} and query ${JSON.stringify(req.query)}`);
            ...
            const { count, totalPages, files } = await FileService.findFilesByRegisterId(fileRegisterId, mainHeadingNumber, branchId, currentPage, pageSize);
