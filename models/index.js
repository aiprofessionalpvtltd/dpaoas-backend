...
db.branchHierarchies = require("./branchHierarchy.model")(sequelize, SequelizeMain)
...
db.furtherAllotmentDays = require('./furtherAllotmentDays.model')(sequelize, SequelizeMain)
...
db.externalMinistries = require('./externalMinistries.model')(sequelize, SequelizeMain)
db.correspondences = require('./correspondences.model')(sequelize, SequelizeMain)
db.correspondenceAttachments = require('./correspondenceAttachments.model')(sequelize, SequelizeMain)
...
db.introducedInSenateBills = require("./introducedInSenateBills.model.js")(sequelize, SequelizeMain);
// Senate Bill Ministry Movers
db.senateBillMinistryMovers = require("./senateBillMinistryMovers.model.js")(sequelize, SequelizeMain);
// Senate Bill Mnas Movers
db.senateBillMnaMovers = require("./senateBillMnaMovers.model.js")(sequelize, SequelizeMain);
// Senate Bill Senator Movers
db.senateBillSenatorMovers = require("./senateBillSenatorMovers.model.js")(sequelize, SequelizeMain);
// Event Calender
db.eventCalenders = require("./eventCalenders.model.js")(sequelize, SequelizeMain);


// bill statuses
db.billStatuses = require("./billStatuses.model.js")(sequelize, SequelizeMain);
// Manage Committee 
db.manageCommittees = require("./manageCommittees.model.js")(sequelize, SequelizeMain);
// Intoduced in house
db.introducedInHouses = require("./introducedInHouses.model.js")(sequelize, SequelizeMain);
// Memeber Passage Details
db.memberPassages = require("./memberPassages.model.js")(sequelize, SequelizeMain);
// Documentation Details bills
db.billDocuments = require("./billDocuments.model.js")(sequelize, SequelizeMain);
// Ordinance Model 
...
db.freshReceipts.belongsTo(db.externalMinistries, { foreignKey: 'fkExternalMinistryId', as: 'externalMinistry' })
...
db.cases.hasMany(db.fileSignatures, { foreignKey: 'fkCaseId', as: 'digitalSignature' })
...
db.filesNotifications.belongsTo(db.users, { foreignKey: 'fkUserId', as: 'users' });
...
db.correspondences.belongsTo(db.branches, { as: 'branch', foreignKey: 'fkBranchId' })
db.correspondences.hasMany(db.correspondenceAttachments, { foreignKey: 'fkCorrespondenceId', as: 'correspondenceAttachments' })
...
db.questions.belongsTo(db.questionStatus, { foreignKey: 'fkQuestionStatus', as: 'questionStatus' });
db.questions.belongsTo(db.members, { foreignKey: 'fkMemberId' });
db.questions.belongsTo(db.noticeOfficeDairies, { as: 'noticeOfficeDiary', foreignKey: 'fkNoticeDiary' });
...
db.questions.hasMany(db.questionDefer, { as: 'questionDefer', foreignKey: 'fkQuestionId' })
db.questions.belongsTo(db.users, { foreignKey: 'deletedBy', as: 'questionDeletedBy' })
...
db.questionDefer.belongsTo(db.questions, { foreignKey: 'fkQuestionId', as: 'deferQuestion' })
db.questionDefer.belongsTo(db.sessions, { foreignKey: 'fkSessionId', as: 'deferredSession' });
db.questionDefer.belongsTo(db.users, { foreignKey: 'deferredBy', as: 'deferredByUser' })
...
db.questionRevival.belongsTo(db.questionStatus, { foreignKey: 'fkQuestionStatus' })
db.questionRevival.belongsTo(db.questionDiary, { foreignKey: 'fkQuestionDiaryId' })
db.questionRevival.belongsTo(db.noticeOfficeDairies, { as: 'noticeOfficeDiary', foreignKey: 'fkNoticeDiaryId' });
db.questionRevival.belongsTo(db.divisions, { as: 'divisions', foreignKey: 'fkDivisionId' })
db.questionRevival.belongsTo(db.groups, { as: 'groups', foreignKey: 'fkGroupId' })
...
db.resolutions.belongsTo(db.noticeOfficeDairies, { foreignKey: 'fkNoticeOfficeDairyId', as: 'noticeDiary' });
...
db.resolutions.belongsTo(db.users, { as: 'deletedBy', foreignKey: 'deletedByUser' })
...
db.manageSessions.hasMany(db.sessionMemberDetails, { foreignKey: 'fkSessionSittingId' })
db.manageSessions.hasMany(db.sessionBreakDetails, { foreignKey: 'fkSessionSittingId' })
...
db.newRota.belongsTo(db.sessions, { foreignKey: 'fkSessionId', as: 'sessions' })
db.newRota.belongsTo(db.groups, { foreignKey: 'fkGroupId', as: 'groups' })
db.furtherAllotmentDays.belongsTo(db.sessions, { foreignKey: 'fkSessionId', as: 'sessions' })
db.furtherAllotmentDays.belongsTo(db.groups, { foreignKey: 'fkGroupId', as: 'groups' })

db.questionQuestionLists.belongsTo(db.questionLists, { foreignKey: 'fkQuestionListId', as: 'questionList' });
...
db.questionSupplementaryLists.belongsTo(db.supplementaryLists, { foreignKey: 'fkSupplementaryListId', as: 'questionSuppList' });
...
db.complaints.belongsTo(db.branches, { as: 'complaintType', foreignKey: 'fkComplaintTypeId' });
db.complaints.belongsTo(db.complaintCategories, { as: 'complaintCategory', foreignKey: 'fkComplaintCategoryId' });
db.complaints.belongsTo(db.tonerModels, { as: 'tonerModels', foreignKey: 'fkTonerModelId' })
...
db.userInventory.belongsTo(db.branches, { as: 'assignedToBranch', foreignKey: 'fkAssignedToBranchId' });
...
db.tonerInstallations.belongsTo(db.branches, { as: 'requestBranch', foreignKey: 'fkBranchRequestId' });
...
//legislative bills 
db.legislativeBills.belongsTo(db.sessions, { foreignKey: 'fkSessionNo', as: 'session' });
db.speechOnDemands.belongsTo(db.sessions, { foreignKey: 'fkSessionNo', as: 'session' });
...
// MNAs association
db.mnas.belongsTo(db.politicalParties, { foreignKey: 'politicalParty', as: 'politicalParties' });
// introduced In Senate Bills
db.introducedInSenateBills.belongsTo(db.parliamentaryYears, { foreignKey: 'fkParliamentaryYearId', as: 'parliamentaryYears' });
db.introducedInSenateBills.belongsTo(db.sessions, { foreignKey: 'fkSessionId', as: 'sessions' })
db.introducedInSenateBills.belongsTo(db.billStatuses, { foreignKey: 'fkBillStatus', as: 'billStatuses' });
db.introducedInSenateBills.belongsTo(db.users, { foreignKey: 'fkUserId', as: 'user' });
db.introducedInSenateBills.hasOne(db.introducedInHouses, { foreignKey: 'fkIntroducedInHouseId', as: 'introducedInHouses' });
db.introducedInSenateBills.hasOne(db.memberPassages, { foreignKey: 'fkMemberPassageId', as: 'memberPassages' });
db.introducedInSenateBills.hasOne(db.billDocuments, { foreignKey: 'fkBillDocumentId', as: 'billDocuments' });
// senate Bill Ministry Movers
db.senateBillMinistryMovers.belongsTo(db.introducedInSenateBills, { foreignKey: 'fkIntroducedInSenateBillId', as: 'senateBillMinistryMovers' });
db.senateBillMinistryMovers.belongsTo(db.ministries, { foreignKey: 'fkMinistryId', as: 'ministrie' });
db.introducedInSenateBills.hasMany(db.senateBillMinistryMovers, { foreignKey: 'fkIntroducedInSenateBillId', as: 'senateBillMinistryMovers' });
// senate Bill Mna Movers
db.senateBillMnaMovers.belongsTo(db.introducedInSenateBills, { foreignKey: 'fkIntroducedInSenateBillId', as: 'senateBillMnaMovers' });
db.senateBillMnaMovers.belongsTo(db.mnas, { foreignKey: 'fkMnaId', as: 'mna' });
db.introducedInSenateBills.hasMany(db.senateBillMnaMovers, { foreignKey: 'fkIntroducedInSenateBillId', as: 'senateBillMnaMovers' });
// senate Bill Member Movers
db.senateBillSenatorMovers.belongsTo(db.introducedInSenateBills, { foreignKey: 'fkIntroducedInSenateBillId', as: 'senateBillSenatorMovers' });
db.senateBillSenatorMovers.belongsTo(db.members, { foreignKey: 'fkSenatorId', as: 'member' });
db.introducedInSenateBills.hasMany(db.senateBillSenatorMovers, { foreignKey: 'fkIntroducedInSenateBillId', as: 'senateBillSenatorMovers' });
// Introduced in house
db.introducedInHouses.belongsTo(db.sessions, { foreignKey: 'fkSessionHouseId', as: 'sessions' });
db.introducedInHouses.belongsTo(db.manageCommittees, { foreignKey: 'fkManageCommitteeId', as: 'manageCommittees' });
db.introducedInHouses.belongsTo(db.introducedInSenateBills, { foreignKey: 'fkIntroducedInHouseId', as: 'introducedInSenateBills' });
// Member Passage Details
db.memberPassages.belongsTo(db.sessions, { foreignKey: 'fkSessionMemberPassageId', as: 'sessions' });
db.memberPassages.belongsTo(db.introducedInSenateBills, { foreignKey: 'fkMemberPassageId', as: 'introducedInSenateBills' });
// Bill documents
db.billDocuments.belongsTo(db.introducedInSenateBills, { foreignKey: 'fkBillDocumentId', as: 'introducedInSenateBills' });
// Ordinance Association
db.ordinances.belongsTo(db.parliamentaryYears, { foreignKey: 'fkParliamentaryYearId', as: 'parliamentaryYears' });
db.ordinances.belongsTo(db.billStatuses, { foreignKey: 'fkOrdinanceStatus', as: 'billStatuses' });
db.ordinances.belongsTo(db.sessions, { foreignKey: 'fkSessionId', as: 'sessions' });
db.ordinances.belongsTo(db.users, { foreignKey: 'fkUserId', as: 'user' });
// private membner bill status 
db.privateMemberBills.belongsTo(db.billStatuses, { foreignKey: 'fkBillStatus', as: 'billStatuses' });
// legislative Bill status
db.legislativeBills.belongsTo(db.billStatuses, { foreignKey: 'fkBillStatus', as: 'billStatuses' });
