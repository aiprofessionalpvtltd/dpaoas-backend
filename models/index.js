...
db.translationRemarks.belongsTo(db.legislativeBills, { foreignKey: 'fkLegislativeBillId', as: 'legislativeBills' });
...
db.legislativeBills.hasMany(db.translationRemarks,{ foreignKey: "fkLegislativeBillId", as: "remarks"})
